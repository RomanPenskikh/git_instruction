...
4. Скачать данные из удаленного репозитория посредством комманты git pull
5. После работы с файлом , отправляйем на удаленный репозиторий измененные данные посредством команды git push.
Оснвоаные команды для выполнения действий из пункта 7:
*git remote add origin (вставляем ссылку на репозиторий созданный в github) - для связки с уделанным репозиторием
