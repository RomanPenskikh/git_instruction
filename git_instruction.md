...
* для удаления ветки (предварительно необходимо перейти в ветку master) выполняем команду git branch -d
* для слияния веток , необходимо перейти в корневую ветку и набрать команду git merge (название ветки которую хотим слить)
